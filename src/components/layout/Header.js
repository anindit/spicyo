                          ...
                          <div className="col-md-9">
                              <div className="full">
                                  <div className="right_header_info">
                                      <ul>
                                          <li className="dinone"><img style={{marginRight:15}} src={mailicon} alt="#"/><a href="#">support@spicyo.com</a></li>
                                          ...
                                          {localStorage.getItem('loggedin')?null:<a class="button active" onClick={this.loginOpenModal} href="javascript:void(0)">Login</a>}
                                                <Modal
                                                    ...
                                                    <div onClick={this.logincloseModal} 
                                                      style={{position: 'absolute', right: 10, top: 10, cursor: 'pointer', width: '35px', height: '35px'}}>
                                                          <img src={cancel} alt="#"/>
                                                    </div>
